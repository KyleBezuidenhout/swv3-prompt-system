<!--
WORKBENCH TEST ASSEMBLY (contract v1.2.1) — paste everything BELOW this comment into the
...
# SWv3 Global Agent Contract — v1.2.1
...
Operator timezone: America/New_York   <!-- EDIT to your test timezone -->
