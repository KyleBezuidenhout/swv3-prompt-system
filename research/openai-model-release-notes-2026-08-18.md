<!-- Source: https://help.openai.com/en/articles/9624314-model-release-notes — captured via Crawl4AI 2026-08-18 -->
[![OpenAI](https://help.openai.com/logo.png)](https://help.openai.com/en)
LanguageEnglish
[Login](https://help.openai.com/auth/login?redirectTo=%2Fauth%2Flogin-success%3FreturnTo%3D%252Fen%252Farticles%252F9624314-model-release-notes)
...
More information on our principles related to teens can be found in our [_ChatGPT for Teens_](https://openai.com/index/chatgpt-for-teens) blog post, and the latest version of the Model Spec is available at [_model-spec.openai.com_](http://model-spec.openai.com).
...
As [_previously announced_](https://openai.com/index/retiring-gpt-4o-and-older-models/), we have retired GPT-4o, GPT-4.1, GPT-4.1 mini, and OpenAI o4-mini from ChatGPT. We are also retiring GPT-5 (Instant and Thinking),[ _as previously announced_](https://openai.com/index/gpt-5-1/). There are no API changes at this time. For details, see our [_blog post_](https://openai.com/index/retiring-gpt-4o-and-older-models/) and [_Help Center_](https://help.openai.com/en/articles/20001051-retiring-gpt-4o-and-other-chatgpt-models).
...
On February 13, 2026, alongside the [_previously announced retirement_](https://openai.com/index/gpt-5-1/)⁠ of GPT‑5 (Instant and Thinking), we will retire GPT‑4o, GPT‑4.1, GPT‑4.1 mini, and OpenAI o4-mini from ChatGPT. In the API, there are no changes at this time. For more, see our [_blog post_](https://openai.com/index/retiring-gpt-4o-and-older-models/) or [_help center_](https://help.openai.com/en/articles/20001051-retiring-gpt-4o-and-other-chatgpt-models).
...
More information can be found in [_this_](https://openai.com/index/updating-model-spec-with-teen-protections/) blog post, and the latest version of the Model Spec is available at [_model-spec.openai.com_](http://model-spec.openai.com).
...
Starting today Codex in both the CLI and IDE Extension will automatically offer you the option to switch to GPT-5-Codex-Mini when you reach 90% of your 5-hour usage limit to help you work longer without interruptions. [Learn more in our Help Center article.](https://help.openai.com/en/articles/11369540-using-codex-with-your-chatgpt-plan)
...
## Related articles
  * [ ChatGPT Business - Release Notes A changelog of the latest updates for ChatGPT Business plan ](https://help.openai.com/en/articles/11391654-chatgpt-business-release-notes)
...
Submit
  * [Updates to the OpenAI Model Spec (August 18, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#updates-to-the-openai-model-spec-august-18-2026)
  * [Introducing GPT-5.6 Sol in ChatGPT (July 9, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#introducing-gpt-56-sol-in-chatgpt-july-9-2026)
  * [GPT-5.5 Instant Update (May 28, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#gpt-55-instant-update-may-28-2026)
  * [Retiring OpenAI o3 and GPT-4.5 (May 28, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#retiring-openai-o3-and-gpt-45-may-28-2026)
  * [GPT-5.4 mini in ChatGPT (March 18, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#gpt-54-mini-in-chatgpt-march-18-2026)
  * [GPT-5.3 Instant update (March 16, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#gpt-53-instant-update-march-16-2026)
  * [Retiring GPT-5.1 models (March 11, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#retiring-gpt-51-models-march-11-2026)
  * [GPT-5.4 Thinking in ChatGPT (March 5, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#gpt-54-thinking-in-chatgpt-march-5-2026)
  * [GPT-5.3 Instant Update (March 3, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#gpt-53-instant-update-march-3-2026)
  * [Retiring GPT-4o and other legacy models (February 13, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#retiring-gpt-4o-and-other-legacy-models-february-13-2026)
  * [GPT-5.2 Instant Update (February 10, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#gpt-52-instant-update-february-10-2026)
  * [Introducing GPT-5.3-Codex (February 5, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#introducing-gpt-53-codex-february-5-2026)
  * [Update on thinking time settings for GPT-5.2 Thinking in ChatGPT (February 4, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#update-on-thinking-time-settings-for-gpt-52-thinking-in-chatgpt-february-4-2026)
  * [Retiring GPT-4o and other legacy models (January 29, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#retiring-gpt-4o-and-other-legacy-models-january-29-2026)
  * [5.2 Personality System Prompt Update (January 22, 2026)](https://help.openai.com/en/articles/9624314-model-release-notes#52-personality-system-prompt-update-january-22-2026)
  * [Updates to the OpenAI Model Spec (December 18, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#updates-to-the-openai-model-spec-december-18-2025)
  * [Introducing GPT-5-Codex-Max (November 19, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_fd9673c91a)
  * [Introducing GPT-5-Codex-Mini](https://help.openai.com/en/articles/9624314-model-release-notes#h_8c42ae7b25)
  * [Updates to the OpenAI Model Spec (October 27, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_02128ae9cb)
  * [Updating GPT-5 (October 3, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_d7ec15c07a)
  * [GPT-5-codex now available in Responses API (Sep 23, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_eb5b153705)
  * [Introducing GPT-5-codex (Sep 15, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_93ebe2c4b1)
  * [Updating the OpenAI Model Spec (September 12, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#updating-the-openai-model-spec-september-12-2025)
  * [GPT-5](https://help.openai.com/en/articles/9624314-model-release-notes#h_b823d984ad)
  * [Introducing two open-weight models: gpt-oss-120b and gpt-oss-20b (August 5, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_6ad724ea39)
  * [Launching OpenAI o3-pro—available now for Pro users in ChatGPT and in our API (June 10, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_77f7e366fe)
  * [Updates to Advanced Voice Mode for paid users (June 7, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_680309a67b)
  * [Update to o4-mini (June 6, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_2254ce7fab)
  * [Releasing GPT-4.1 in ChatGPT for all paid users (May 14, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_8e49be5daa)
  * [Introducing GPT-4.1 mini, replacing GPT-4o mini, in ChatGPT for all users (May 14, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_a0741cadac)
  * [Improvement to GPT-4o (May 12, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_5c03e2e4ce)
  * [Update to GPT-4o (April 29, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_0515e16897)
  * [Improvements to GPT-4o (April 25, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_c1a44ec070)
  * [OpenAI o3 and o4-mini (April 16, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_cfb262abff)
  * [Improvements to GPT-4o (March 27, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_cc687480a4)
  * [Smarter problem-solving in STEM and coding:](https://help.openai.com/en/articles/9624314-model-release-notes#smarter-problem-solving-in-stem-and-coding)
  * [Enhanced instruction-following and formatting accuracy:](https://help.openai.com/en/articles/9624314-model-release-notes#enhanced-instruction-following-and-formatting-accuracy)
  * [“Fuzzy” improvements:](https://help.openai.com/en/articles/9624314-model-release-notes#fuzzy-improvements)
  * [Introducing GPT-4.5 (February, 27, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_c419395074)
  * [Introducing OpenAI o3-mini (January 31, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#h_cb793d13ca)
  * [Updates to GPT-4o in ChatGPT (January 29, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#updates-to-gpt-4o-in-chatgpt-january-29-2025)
  * [Introducing GPT-4o with scheduled tasks (January 14, 2025)](https://help.openai.com/en/articles/9624314-model-release-notes#introducing-gpt-4o-with-scheduled-tasks-january-14-2025)
  * [Update to GPT-4o (November 20, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#update-to-gpt-4o-november-20-2024)
  * [Update to GPT 4o-mini (November 5, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#h_3b4cfad437)
  * [Introducing GPT-4o with canvas (October 3, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#h_f7a0c4137a)
  * [Advanced voice (September 24, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#h_5b08ef7f5e)
  * [Introducing OpenAI o1-preview and o1-mini (September 12, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#h_834fc2a3cc)
  * [Update to GPT-4o (September 3, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#h_4312691c80)
  * [Update to GPT-4o (August 12, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#h_23afdcd0a7)
  * [Introducing GPT-4o mini (July 18, 2024)](https://help.openai.com/en/articles/9624314-model-release-notes#h_c54335ba28)


![OpenAI logo](https://help.openai.com/favicon.png)[ChatGPT](https://chatgpt.com)[API](https://platform.openai.com/docs/)[Service Status](https://status.openai.com)Cookie Preferences
